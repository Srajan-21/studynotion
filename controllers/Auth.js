    ...
    exports.signUp = async (req ,res)=>
        {
            ...
            const user = await User.create({
                ...
                image:`ttps://api.dicebear.com/5.x/initials/svg/?seed=${firstName} ${lastName}`
            })
            ...
            return res.status(500).json({
                success:false,
                message:"Iser cannnot be registered . Please try Again",
            })
        }
    }
